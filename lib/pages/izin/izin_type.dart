...
class IzinType extends StatefulWidget {
  @override
  _IzinTypeState createState() => _IzinTypeState();
}

class _IzinTypeState extends State<IzinType> {
  ...
  Future getData() async {
    ...
    _devService.tipeIzin(accesToken).then((value) async {
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    child: Text(
                      item['is_file'] == 1 ? 'Membutuhkan file pendukung' : '-',
                      style: TextStyle(
                          fontFamily: 'Poppins-Regular',
                          fontSize: 14,
