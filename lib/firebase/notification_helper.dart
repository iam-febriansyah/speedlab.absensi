...
import 'package:flutter_application_1/models/cls_notification.dart';
...
class NotificationHelper {
  ...
  static const _channelDesc = "galerierp channel";
  ...
  Future<void> showNotification(String title, String body,
    ...
    var androidPlatformChannelSpecifics =
        AndroidNotificationDetails(_channelId, _channelName, _channelDesc,
            icon: 'app_icon',
            // icon: 'secondary_icon',
